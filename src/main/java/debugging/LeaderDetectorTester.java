...
import pbft.leaderdetection.TrustLeader;
...
public class LeaderDetectorTester extends GenericProtocol {
    ...
    public void init(Properties properties) throws HandlerRegistrationException, IOException {
        ...
        registerReplyHandler(TrustLeader.REPLY_ID, this::uponChange);
        setupTimer(new ComplainTimer(), ThreadLocalRandom.current().nextLong(0, 2000));
    }
    void uponChange(TrustLeader l, short source){
        cur_leader = l.getLeader();
        System.out.println("new leader: "+cur_leader.toString());
    ...
    public static void main(String[] args) throws InvalidParameterException, IOException, HandlerRegistrationException, ProtocolAlreadyExistsException {
        ...
        ByzantineLeaderDetector bld = new ByzantineLeaderDetector();
        LeaderDetectorTester tester = new LeaderDetectorTester();
