...
public class PbftClient extends ConditionalGenericProtocol {
    private static final File OUTPUT_DIR = new File("output");
    private static final short REPLICAID = PbftReplica.PROTO_ID;
    private static final String REPLICANAME = PbftReplica.PROTO_NAME;

    private static final String PROTO_NAME = "PbftClient";
    public static final short PROTO_ID = 400;
    public static final double DELTA = 200;
    public static final int NUM_REPETITIONS = 60;
    public static final BenchmarkingChannel.Distribution DISTRIBUTION = new BenchmarkingChannel.Normal(0,0);
    public static AsymmetricTrustSystem ATS = new SevenATS();
    ...
    public static class OneShotConsensus {
        ...
        public void APBFT_One_shot_consensus_toy_ats(BenchmarkingChannel.Distribution distribution, int run_id, double delta ) {
            ...
            for(Proc p : members){
                ...
                pb.command("java", "-jar", "Jars/PbftReplica.jar");
