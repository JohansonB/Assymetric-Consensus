...
public class PbftReplica extends ConditionalGenericProtocol {
    public static final String PROTO_NAME = "PbftReplica";
    ...
    public void init(Properties properties) throws HandlerRegistrationException, IOException {
        ...
        for(Proc p : peers){
            sendMessage("isSetup",msg,p,PbftReplica.PROTO_ID);
        }
    ...
    private void uponReady() {
        ...
        sendMessage("isSetup",msg,client,PbftClient.PROTO_ID);
    }
    ...
    private void uponPBFTDecide(PBFTDecide dec, short i){
        ...
        sendMessage("decided",msg,client,PbftClient.PROTO_ID);
    }
