...
import recpbft.EpochStatePredicateTracker;
import recpbft.conditionalcollect.CCSetup;
import recpbft.conditionalcollect.CollectedOutput;
import recpbft.conditionalcollect.ConditionalCollect;
import recpbft.conditionalcollect.InputRequest;
import trustsystem.*;
...
public class EpochConsensus extends ConditionalGenericProtocol {
    ...
    public void init(Properties properties) throws HandlerRegistrationException, IOException {
        ...
        tracker = new EpochStatePredicateTracker(asymmTrustSystem,leader);
