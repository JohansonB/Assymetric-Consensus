...
public class SevenATS extends AsymmetricTrustSystem {
    public static final int start_port = 5000;
    public static final String address = "127.0.0.1";
    public SevenATS(AsymmetricTrustSystem ats){
    ...
    public SevenATS() {
        ...
        p_s.add(members.get(6));
        p_sets.add(new ProcSet(p_s));

        t_s = new TrustSystem(new FaultSystem(new HashSet<>()),new QuorumSystem(p_sets));
        ats.put(members.get(6),t_s);
    ...
    @Override
    public SevenATS permute(HashMap<Proc,Proc> per){
        return new SevenATS(super.permute(per));
    }
    @Override
    public SevenATS permute(){
        return new SevenATS(super.permute());
    }
